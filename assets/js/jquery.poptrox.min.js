					...
					// Create object (based on type)
						...
						switch (x.type) {
                            ...
                            case 'youtube':
                                ...
                                x.object = $('<img src=""><br><br><a id="selecting" style="margin-top: 20px; padding: 5px 10px; font-size: 20px !important; background-color: #59b1ff; border-radius: 12px;">確定新增</a>');
                                    //document.getElementById('word').innerHTML=document.getElementById(tmp[1]).innerHTML; 
                                x.src = 'images/' + tmp[1]  + '.jpg';
                                //var words = document.getElementById(tmp[1]).innerHTML;
